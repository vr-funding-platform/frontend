...
function Footer () {
    ...
    <footer>
            ...
            <div class="footer-social">
                ...
                <div className="sml">
                 <a class="fab fa-facebook" href="https://www.facebook.com/sixrvr ">
                    <IoLogoFacebook className="facebook" />
                    </a>
                    <a class="fab fa-twitter" href="https://twitter.com/sixrvr">
                    <IoLogoTwitter className="twitter" />
                    </a>
                    <a class="fab fa-youtube"href="https://www.youtube.com/channel/UCVavPlD8iCYHyKhVJ06PAlw/featured ">
